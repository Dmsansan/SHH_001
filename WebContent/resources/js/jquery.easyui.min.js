...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"此输入框为必填项！",invalidMessage:null,tipPosition:"right",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_4c7,blur:_4cb,mouseenter:_4ce,mouseleave:_4d1,click:function(e){
var t=$(e.data.target);
...
},message:"请确认输入的字符长度在 {0} 和 {1}之间！"},remote:{validator:function(_4f9,_4fa){
var data={};
data[_4fa[1]]=_4f9;
